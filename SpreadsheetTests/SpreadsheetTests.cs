...
public class SpreadsheetTests
{
    ...
    {
        tester.SetContentsOfCell("A1", "");
        tester.SetContentsOfCell("A2", "");
        tester.SetContentsOfCell("A3", "");
        tester.SetContentsOfCell("A4", "");
        tester.SetContentsOfCell("A5", "");
        Assert.AreEqual(0,tester.GetNamesOfAllNonemptyCells().Count());
    }
    /// <summary>
    /// Test if get saved version returns the correct version
    /// </summary>
    [TestMethod]
    public void TestGetSavedVersion()
    {
        tester.SetContentsOfCell("A1", "10.0");
        tester.SetContentsOfCell("A2", "5");
        tester.SetContentsOfCell("A3", "8");
        tester.SetContentsOfCell("A4", "3");
        tester.SetContentsOfCell("A5", "A1+A2");
        tester.Save("brave.txt");
        tester.GetSavedVersion("brave.txt");
        // Assert.AreEqual("Default", tester.GetSavedVersion("save.txt"));
    }
    [TestMethod]
    public void TestFourParamConstructor()
    {
        ...
        // tester.SetContentsOfCell("A5", "A1+A2");
        // tester.Save("brave.txt");
        Spreadsheet ss = new Spreadsheet("brave.txt", s => true, s => s, "1");
        
    }
    /// <summary>
    /// Test if get saved version throws an exception when a bad file gets passed in.
    /// </summary>
    [TestMethod]
    ...
    public void TestGetSavedVersionException()
    {
        ...
        tester.SetContentsOfCell("A4", "3");
        tester.SetContentsOfCell("A5", "A1+A2");
        tester.Save("save.txt");
        tester.GetSavedVersion("ave.txt");
    }
    [TestMethod]
    public void TestSave()
    {
        ...
        tester.SetContentsOfCell("A3", "8");
        tester.SetContentsOfCell("A4", "3");
        tester.SetContentsOfCell("A5", "1");
        Assert.AreEqual(5,tester.GetNamesOfAllNonemptyCells().Count());
        tester.Save("testSave.txt");
        Assert.AreEqual("Default", tester.GetSavedVersion("testSave.txt"));
    }
    /// <summary>
    ...
    public void TestGetNamesOfNonEmptyCellContents()
    {
        ...
        tester.SetContentsOfCell("A2", "");
        tester.SetContentsOfCell("A3", "");
        tester.SetContentsOfCell("A4", "Ants");
        tester.SetContentsOfCell("A5", "5");
...
/// </summary>
    ...
    public void TestGetCellContents()
    {
        ...
        tester.SetContentsOfCell("A1", "5");
        tester.SetContentsOfCell("A2", "A1 + 5");
        tester.SetContentsOfCell("A3", "hi");
...
/// <summary>
/// Checks to make sure getcellcontents return an empty string if the cells don't have anything in it.
/// </summary>
    [TestMethod]
    public void TestGetCellContentsWithInvalidName()
    {
        ...
        tester.SetContentsOfCell("A4", "Ants");
        tester.SetContentsOfCell("A5", "5");
        Assert.AreEqual("", tester.GetCellContents("A6"));
    }
    ...
    //     tester.SetContentsOfCell("A1", test1);
    //     tester.SetContentsOfCell("B1", test2);
    //     tester.SetContentsOfCell("C1", test3);
    //     tester.SetContentsOfCell("D1", test4);
    // }
